...
senior leadership with daily operations, coordinate interdepartmental meetings, and
collaborate effectively with Local Government Units (LGUs) and various government
agencies.<br><br> Expertise in providing technical guidance on urban-poverty issues, managing
data on urban initiatives, and conducting research and policy analysis. <br><br>Adept at
supporting the planning and execution of urban development events, while fostering
strong stakeholder relations. Known for delivering actionable policy recommendations
and contributing to the successful development, implementation, and monitoring of
urban projects and poverty alleviation programs.`,
...
Strategic National Command: He serves as the chief architect of unity, harmonizing the interests of diverse island groups into one cohesive movement. He is the authoritative voice in high-level negotiations with government agencies, ensuring the organization’s vision is backed by legal and political strength.

Operational Stewardship: He executes the day-to-day survival and growth of the cooperative, transforming complex policies into tangible livelihood programs. His management is a masterclass in balance—maintaining rigorous financial discipline and compliance while ensuring that the "humane" heart of the cooperative remains focused on member welfare.

Rex Moran Loba does not just occupy a position; he carries the weight of a national mission. His "strong leadership" is the bridge between institutional power and grassroots empowerment, ensuring that as the organization rises, every member across the archipelago rises with it.`,
...
<br><br>
I prioritize accurate reporting and sales analysis, identifying key drivers and maintaining essential checklists for stock flow and compliance. My focus on visual merchandising ensures that best sellers and new products are showcased effectively, adhering to brand guidelines.
<br><br>
By fostering a culture of motivation and product knowledge, I empower my team to deliver outstanding customer experiences, ultimately driving us to exceed sales targets and achieve company objectives.`,
        title: 'Store Manager',
    },
    alshaya: {
...
<br><br>
I oversee various reports, including sales analysis and daily sales updates, ensuring accuracy in stock transfers and compliance with company procedures. My role in visual merchandising ensures that best sellers and new products are strategically positioned to optimize sales.
<br><br>
I also focus on reducing stock loss by adhering to company policies and utilizing security measures effectively. By motivating my team and promoting excellent customer service and product knowledge, I strive to exceed sales targets and achieve company objectives. My approach combines leadership, operational oversight, and a strategic focus on sales growth and customer satisfaction.`,
...
preparing ad-hoc reports, and using data-driven insights to support strategic decision-
making. Skilled in evaluating team performance, providing mentorship, and fostering a
positive, growth-oriented work environment. Adept at implementing new strategies and
tools to enhance performance, drive continuous improvement, and achieve
organizational targets.<br><br> Known for optimizing team capabilities, empowering members to
reach their full potential, and ensuring a cohesive approach to success.`,
...
My focus is on improving operational processes and monitoring key metrics to align with company goals. I collaborate with other departments, prepare performance reports, and manage risks effectively. By leading training and development initiatives, I ensure that my team maintains high service standards, playing a vital role in our overall success.<br><br>
During My Tenure I was able to improve the collection rate from 60% to 85%. I was also able to find out about unremitted payments sent to the collectors and have dealth with them accordingly.`,
...
<br><br>
In the Accounting Department, I maintain accurate financial records, assist with bookkeeping, and ensure compliance with accounting standards. I also help reconcile accounts, prepare financial statements, and support audits. My role involves close collaboration with internal teams to ensure smooth operations and precise financial reporting for both loan and accounting activities.`,
...
const engagementsdata =
{
    ...
    },
    {
        ...
        <br><br>
        PCUP thanks the Ifugao LGUs for their active participation, highlighting the strong partnership between national and local leaders in addressing urban poor needs.<br><br>
    ...
    },
    {
        ...
        During the meeting, Mr. Rex Moran Loba- Technical Specialist II, effectively outlined the PCUP’s vision, shared current challenges, and presented opportunities for collaboration. The discussions covered key areas such as housing, healthcare, education, and livelihood programs, all of which are critical in improving the quality of life for the urban poor in the Philippines.`,
    },
    {
    ...
    },
    {
        ...
        4. Assessment and Improvement of Team Performance (KPI)<br><br>
        The training aimed to enhance the overall management skills of staff, fostering a more effective and cohesive team environment at Al Shamsi Holdings.
        `,
    },
    ...
    "Al SHAYA GROUP LLC – KINGDOM OF  BAHRAIN": [
        {
            ...
            The program aimed to empower employees with the skills to boost sales, enhance brand presentation, and improve customer satisfaction, contributing to overall business growth.
            `,
        },
    ...
    "SM Development Corporation (SMDC)": [
        {
            ...
            The sessions focus on helping OFWs invest in properties and secure their future with accessible and profitable options.
...
let recognitioncertificates = {
    'Recognitions': [
        ...
        },
        {
            ...
            It was an inspiring experience to witness such exceptional talent and contribute to recognizing the best in the competition.
            `,
        },
        {
            ...
            It was a rewarding experience to see such diverse talents and skillful craftsmanship, and I’m proud to have been part of recognizing the best in this vibrant community
            `,
        },
        {
        ...
        },
        {
           ...
           focusing on the implementation of national government programs across all LGUs.
            `,
        },
        {
        ...
        },
        {
         ...
         Excelled in staff training, leading to promotions within the team.
            `,
        },
...
function GenerateColGalleryICON(LoadDataOnclick, columnclass, imgsrc, Text, imgwidth = '50%', imgheight = '', textstyle = '', boxstyle = '', ahref = 'javascript:void(0);', cv_banner_boxCLASS = 'cv_banner_box') {

    if (!boxstyle) { boxstyle = 'width: 100%; height: 100%; object-fit: cover; padding:0px; padding-top:5px;'; }
    if (!cv_banner_boxCLASS) { cv_banner_boxCLASS = 'cv_banner_box'; }
    if (!imgheight) { imgheight = '100%'; }
    if (!imgwidth) { imgwidth = '50%'; }
    if (!textstyle) { textstyle = 'color: white; font-size:1.8vw; padding-top:10px; padding-bottom:10px; padding-left:5px; padding-right:5px;'; }
    if (!columnclass) { columnclass = 'col'; }

    return `
            <div class="${columnclass}">
                        <div class="${cv_banner_boxCLASS}" style="${boxstyle}">
                            <a href="${ahref}" onclick="${LoadDataOnclick}">
                                <center><img src="${imgsrc}" style="width: ${imgwidth};height: ${imgheight};"
                                        class="cv_toggle_btn" alt="" loading="lazy"><br>
...
const closeBtn = document.getElementsByClassName("close")[0] || false;
const modal = document.getElementById("imageModal") || false;
const fullImage = document.getElementById("fullImage") || false;
...
$('.cv_toggle_btn').on('click', function () {
    ToggleMenu();
});